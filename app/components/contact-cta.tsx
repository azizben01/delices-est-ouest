...
const FacebookUrl =
  "https://www.facebook.com/share/1CRTSKvz49/?mibextid=wwXIfr";
const TIKTOK_URL = "https://www.tiktok.com/@delices.estouest";
// const PHONE_NUMBER = "+25769641051";
    ...
    <section className="w-full flex-1 flex flex-col justify-center px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-9 bg-sky-50 min-h-0">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-stretch sm:items-center">
          ...
          >
            <FaWhatsapp className="w-5 h-5 sm:w-6 sm:h-6 shrink-0" />
            <span>Whatsapp</span>
          </button>
