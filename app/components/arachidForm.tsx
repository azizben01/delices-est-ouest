...
export default function ArachideForm({ productName }: Props) {
  const variants: Variant[] = useMemo(
    () => [
      {
        id: "arachidGrilleSale",
        label: "Arachides grillées salées",
        unitPrice: 25000,
      },
      { id: "arachidSucre", label: "Arachides sucrées", unitPrice: 25000 },
      {
        id: "gingembreMiel",
        label: "Cacahuètes gingembre au miel",
        unitPrice: 15000,
      },
      { id: "petitCola", label: "Cacahuètes petit cola", unitPrice: 25000 },
    ],
    [],
  );
    ...
    <div className="max-w-4xl mx-auto p-6 md:p-8">
      ...
      <div className="mb-8">
        <h2 className="text-2xl md:text-3xl font-delius font-medium text-stone-800 mb-2">
          Nous avons plusieurs variante d'arachide
        </h2>
        <p className="text-stone-500 font-delius text-sm">
          Selectionnez le type d'arachide que vous voulez commander
        </p>
      </div>
